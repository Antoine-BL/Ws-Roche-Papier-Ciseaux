...
public class WebSocketApplication implements CommandLineRunner {
	...
	private void subscribeToPublicMessageQueue() {
		stompSession.subscribe(PUBLIC_INPUT_QUEUE, new StompFrameHandler() {
			@Override
	...
	private void periodicallyPingClient() throws InterruptedException, ExecutionException {
		while(true) {
	...
	private void pingClient(Message msg) {
		System.out.println("session ok.");
		stompSession.send(PUBLIC_OUTPUT_QUEUE, msg);
	}
}
