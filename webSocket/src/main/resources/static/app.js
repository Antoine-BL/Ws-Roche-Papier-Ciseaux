...
$(document).ready(() => {
    $('#connexionMessageriePrivee').show();
    $('#connexionMessageriePublique').show();
    $('#messageriePrivee').hide();
    $('#messageriePublique').hide();

    $('#btnConnexionMessageriePrivee').click(connexionPrive);
    $('#btnConnexionMessageriePublique').click(connexionPublique);
    $('#btnEnvoyer').click(() => sendName($('#tbMessagePublique')));
    $('#btnEnvoyerPrive').click(sendNamePrivate);

    $("#frmEnvoyer").on('submit', function (e) {
        e.preventDefault();
    });

    $("#frmEnvoyerPrive").on('submit', function (e) {
        e.preventDefault();
    });
    ...
    function setPublicConnection(connected) {
        $('#btnConnexionMessageriePublique').prop("disabled", !connected);
        if (connected) {
            $('#connexionMessageriePublique').hide();
            $('#messageriePublique').show();
        } else {
            $('#connexionMessageriePublique').show();
            $('#messageriePublique').hide();
        }
    ...
    function setPrivateConnection(connected) {
        $('#btnConnexionMessageriePrivee').prop("disabled", !connected);
        if (connected) {
    ...
    function showPublique(message) {
        $("#messageriePublique").append( message + '<br/>');
    }

    function showPrive(message) {
        $("#messageriePrivee").append( message + '<br/>');
    }
});
...
function serializeMessage(from){
